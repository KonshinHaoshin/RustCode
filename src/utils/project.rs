...
pub fn init_project(name: &str) -> anyhow::Result<()> {
    ...
    // Create RUSTCODE.md file
    let rustcode_md = format!(
        "# {}\n\nThis project was initialized with RustCode.\n\n## Structure\n\n- `src/` - Source code\n- `RUSTCODE.md` - Project notes for RustCode\n\n## Getting Started\n\nStart coding with RustCode!\n",
        name
    );
