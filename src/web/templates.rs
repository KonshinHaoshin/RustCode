...
<head>
    ...
    <title>RustCode Plugin Marketplace</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <header>
            <h1>🔌 RustCode Plugin Marketplace</h1>
            <p class="subtitle">Discover and install plugins to extend RustCode's capabilities</p>
        ...
        <footer>
            <p>RustCode Plugin Marketplace v{}</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Plugin Details - RustCode Marketplace</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Search Plugins - RustCode Marketplace</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
