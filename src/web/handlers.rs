...
fn get_sample_plugins() -> Vec<Plugin> {
    vec![
        Plugin {
            ...
            author: "RustCode Team".to_string(),
            author_url: Some("https://github.com/KonshinHaoshin/claude-code-rust".to_string()),
            repository_url: Some("https://github.com/KonshinHaoshin/claude-code-rust".to_string()),
            documentation_url: Some(
                "https://github.com/KonshinHaoshin/claude-code-rust".to_string(),
            ),
            icon_url: None,
            tags: vec![
                "files".to_string(),
        ...
        Plugin {
            ...
            description: "Send notifications and interact with Slack from RustCode".to_string(),
